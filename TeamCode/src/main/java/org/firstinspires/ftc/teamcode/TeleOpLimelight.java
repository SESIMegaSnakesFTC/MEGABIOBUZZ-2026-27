...
public class TeleOpLimelight extends LinearOpMode {
    ...
    public void Trackinglimelight(LLResult resultado, double Tx){
        ...
        //>>Defining Position of Turret's using LimeServo paezao<<
    ...
    public double Sin(double anglin){ return tabelaValorSin.get(Math.round(anglin)); }
